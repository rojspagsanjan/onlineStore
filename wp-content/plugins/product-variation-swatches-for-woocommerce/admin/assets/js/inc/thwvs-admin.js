var thwvsf_settings = (function($, window, document) {
    ...
    *------------------------------------*/
    ...
    $(document).ready(function(){
       setTimeout(function(){
          $("#thwvsf_review_request_notice").fadeIn(500);
       }, 2000);
    });
    ...
    function hide_review_request_notice(elm){
        ...
        var data = {
            security: nonce,
            action: 'skip_thwvsf_review_request_notice',
        };
        $.post( ajaxurl, data, function() {
...
function thwvsfHideReviewRequestNotice(elm){
    thwvsf_settings.hideReviewRequestNotice(elm);
}
